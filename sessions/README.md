...
| 5 | [Automate Your Career & Build on the Side (Stress-Free)](session-05-career/) | Career leverage + side-project compounding system | ⏳ In production |

## Format

Every session follows the same recording structure to keep quality predictable:

1. **Cold Open** (2 min) — a real outcome, not a slide
2. **The Idea** (10 min) — one principle, taught as a way of thinking
3. **The Trap** (5 min) — what goes wrong when you do it naively
4. **The System** (10 min) — the repeatable workflow you can copy-paste
5. **The Assignment** (3 min) — one specific task you can complete in under an hour
